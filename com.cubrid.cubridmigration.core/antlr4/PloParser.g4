...
number_type
    : NUMBER (LPAREN precision=UNSIGNED_INTEGER (',' scale=UNSIGNED_INTEGER)? RPAREN)?
    ;

char_type
    : CHAR ( LPAREN length=UNSIGNED_INTEGER RPAREN )?
    | NCHAR ( LPAREN length=UNSIGNED_INTEGER RPAREN )?
    ;

varchar2_type
    : VARCHAR2 ( LPAREN length=UNSIGNED_INTEGER RPAREN )?
    | NVARCHAR2 ( LPAREN length=UNSIGNED_INTEGER RPAREN )?
    ;
